...
public class Aula4GregorianCalendar {
	...
	public static void main(String[] args) {
		...
		//Calender classe abstrata, na vdd getInstance instancia de GreogrianCalender
		Calendar hoje1 = Calendar.getInstance();

		//Como não é abstrata e nao segue padrão sigleton, pode ser instanciado
		...
		System.out.println("Ano é bissexto? " + hoje.isLeapYear(2020));
