...
public class Aula9DataJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(agora.plusDays(30)); // +30 dias

		System.out.println(agora.minus(1, ChronoUnit.MONTHS)); // -1 mês

		System.out.println(agora.getDayOfWeek());
		System.out.println(agora.getDayOfMonth());
		System.out.println(agora.getDayOfYear());

		System.out.println(LocalDate.parse("2020-02-01").isLeapYear()); //bissexto

		// hora formato ISO
		LocalTime hAgora = LocalTime.now(); //hora agora
		...
		// data completa = data + hora(padrão ISO)
		...
		//Trabalhar fuso horário com localDate
...
//				}
		...
		//para converter date ou calender para a api:
		Date date = new Date();
