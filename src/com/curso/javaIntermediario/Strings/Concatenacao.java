...
public class Concatenacao {
	...
	public static void main(String[] args) {
		...
		String resultado2Com2 = "Resultado 2+2 = " + (2 + 2); //executa primeiro expressão numérica
		System.out.println(resultado2Com2);

		String resultado2Com2_ = "Resultado 2+2 = " + 2 + 2; //é transformado em string
		...
		//Ao concatenar a referencia da variavel que estamos trabalhando, irá apontar para nova referencia
		//As strings que não são mais referenciadas ficam disponiveis para o Garbage Collection
