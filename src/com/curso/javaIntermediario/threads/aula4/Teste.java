...
public class Teste {
	...
	public static void main(String[] args) {
		...
		t1.setPriority(5); //numero maior, maior prioridade (nem sempre prioridade é cumprida)
		t2.setPriority(3);
		t3.setPriority(1);

		// t1.setPriority(Thread.NORM_PRIORITY); opção ao inves de numero para representar prioridade
